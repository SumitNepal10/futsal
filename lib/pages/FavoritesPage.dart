    ...
    return Scaffold(
      ...
      body: Consumer<FavoritesService>(
        builder: (context, favoritesService, child) {
          final favoriteFutsals = _futsals
              .where((futsal) => favoritesService.isFavorite(futsal['id']))
              .toList();

          if (favoriteFutsals.isEmpty) {
            return const Center(
              child: Text('No favorite futsals yet'),
            );
          }

          return ListView.builder(
            padding: const EdgeInsets.all(16),
            itemCount: favoriteFutsals.length,
            itemBuilder: (context, index) {
              final futsal = favoriteFutsals[index];
              return Card(
